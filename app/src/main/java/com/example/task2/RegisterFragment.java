...
public class RegisterFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        EditText emailEditText = view.findViewById(R.id.registerEmailAddress);
        EditText passwordEditText = view.findViewById(R.id.registerPassword);
        EditText confirmPasswordEditText = view.findViewById(R.id.registerConfirmPassword);
        EditText phoneEditText = view.findViewById(R.id.registerPhone);
